...
//   const { field } = useParams(); // ✅ 수정하려는 항목 받기 (예: name, email)
...
//           Authorization: `Bearer ${token}`, // ✅ 기존 스타일에 맞춰 토큰 추가
//         },
...
//         navigate(`/ProfileInfo`); // ✅ 수정할 페이지로 이동
//       } else {
...
//           {passwordError && <p className="error-text">비밀번호가 일치하지 않습니다.</p>}

//           <div className="check-password-buttons">
//             <button className="cancel-button" onClick={() => navigate(-1)}>취소</button>
//             <button className="confirm-button" onClick={handlePasswordCheck}>확인</button>
//           </div>
//         </div>
//       </Page>
//     </Background>
